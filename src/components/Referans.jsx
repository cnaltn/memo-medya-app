    ...
    <div className="w-full flex flex-col container pt-6 pb-6 gap-y-10">
      ...
      <div className=" grid grid-cols-7 items-center gap-10">
        ...
        <img
          ...
          width={100}
          height={100}
          src="https://upload.wikimedia.org/wikipedia/tr/d/d8/Avrasya_%C3%9Cniversitesi_logosu.jpg"
        ></img>
        <img
          className="cards"
          width={100}
        ...
        <img
          ...
          width={100}
          height={100}
          src="https://upload.wikimedia.org/wikipedia/tr/5/5b/Trabzon_B%C3%BCy%C3%BCk%C5%9Fehir_Belediyesi_logo.png"
        ></img>
      </div>
    </div>
  );
